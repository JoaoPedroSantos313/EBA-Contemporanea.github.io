...
export const InfoCard = ({ artista, goToArtist, videoEmbedLink = null }) => {
    ...
    return (
        <div className='card_container' onClick={() => { active && goToArtist(publicId) }}>
            <div className={`title ${!active ? 'card_deactivated' : 'card_title'}`}>
            ...
            <div className="card_image">
                ...
                />
                : <img src={fotoCard ? fotoCard : 'no_img.png'} width="100%" height="100%" />
                }
            </div>
        </div>
    )
